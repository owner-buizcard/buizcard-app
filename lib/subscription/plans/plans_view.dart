...
class _PlansViewState extends State<PlansView> {
  ...
  @override
  void initState() {
    _viewModel = PlansViewModel(context);
    super.initState();
  }
    ...
    return BlocListener<SubscriptionBloc, SubscriptionState>(
      listener: (context, state) {
        if(state is OrderCreated){
          _viewModel.startPayment(state.orderId);
        }else if(state is SubscriptionSuccess){
          Navigator.pop(context);
        }
      },
      child: ValueListenableBuilder(
        valueListenable: _viewModel.isMonthly,
        builder: (_, isMonthly, __) {
                ...
                return Scaffold(
                  ...
                  bottomNavigationBar: Container(
                      ...
                      decoration: const BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color: Color.fromARGB(37, 124, 123, 123),
                                blurRadius: 4)
                          ]),
                      child: ListTile(
                        title: Text(
                            '${isMonthly ? selectedPlan.price['m']['amount_string'] : selectedPlan.price['y']['amount_string']}',
                        ...
                        trailing: SizedBox(
                            ...
                            child: ElevatedButton(
                                onPressed: () => _viewModel.createOrder(isMonthly),
                    ...
                    children: [
                      Padding(
                        ...
                        child: AnimatedToggleSwitch.size(
                          ...
                          values: const [0, 1],
                          onChanged: ((i) => _viewModel.isMonthly.value = (i == 0)),
                      ...
                      ...Global.plans.map((e) {
                        return Padding(
                          ...
                          child: ListTile(
                            onTap: () =>
                                _viewModel.selected.value = Global.plans.indexOf(e),
                            ...
                            subtitle: Text(e.description,
                                style: GoogleFonts.inter()
                                    .copyWith(fontSize: 12, color: Colors.grey)),
                            trailing: Text(
                                '${isMonthly ? e.price['m']['amount_string'] : e.price['y']['amount_string']}',
                                style: GoogleFonts.inter().copyWith(
                                    fontSize: 20, fontWeight: FontWeight.w700)),
                      ...
                      const Gap(size: 16),
                      const Text('All that you will get with this package',
                          style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.w700,
